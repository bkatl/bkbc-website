...
(function() {
	...
	function init() {
		...
		leftSide.querySelector( 'div.profile, .more-design' ).addEventListener( eventtype, function( ev ) {
			reset();
			classie.add( splitlayout, 'open-left' );
		} );

		rightSide.querySelector( 'div.profile, .more-dev' ).addEventListener( eventtype, function( ev ) {
			reset();
