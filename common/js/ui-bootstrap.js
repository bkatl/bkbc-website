...
angular.module("template/carousel/carousel.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/carousel/carousel.html",
    ...
    "    <a ng-click=\"prev()\" class=\"carousel-control left\" ng-show=\"slides().length > 1\"><image xlink:href='common/images/arrow_left.svg' src='common/images/arrow_left.png'/></a>\n" +
    "    <a ng-click=\"next()\" class=\"carousel-control right\" ng-show=\"slides().length > 1\"><image xlink:href='common/images/arrow_right.svg' src='common/images/arrow_right.png'/></a>\n" +
    "</div>\n" +
    "");
}]);
